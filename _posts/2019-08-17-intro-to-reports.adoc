...
In this introduction to reports and document generation, the building blocks of the CUBA application component `reports` were explained. A report is the concept that allows to merge a document template with data from data sources to produce an output document.
