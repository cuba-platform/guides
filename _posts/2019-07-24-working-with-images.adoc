...
<4> the handler for the edit button triggers the passed in `vetSelectionHandler`, so the associated actions can be controlled from the outside of this factory method
