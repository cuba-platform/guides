...
image::data-model-composition/one-level-owner-editor-address-composition.png[align="center"]
...
* When a user clicks *OK* in the `Owner` edit screen, the updated `Owner` instance together with all the updated `Address` instances is submitted to the <<dataManager,DataManager>>.commit() method on the middleware and saved to the database within a single transaction.
...
image::data-model-composition/two-levels-pet-editor-health-records-composition.png[align="center"]
image::data-model-composition/two-levels-healthRecord-editor-health-record-attachments-composition.png[align="center"]
