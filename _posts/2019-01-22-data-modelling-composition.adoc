...
* `Owner` entity gets an relationship to an `Address`
* `Pet` can contain multiple `HealthRecord` instances, which itself can contain multiple `HealthRecordAttachment` instances
