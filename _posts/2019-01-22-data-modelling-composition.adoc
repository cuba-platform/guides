...
Besides the above explained Composition of type `ONE-TO-MANY`, there is also the possibility to define Composition of type `ONE-TO-ONE`. This type of Composition is useful when it is only possible to have one item of the child entity. An example in the petclinic would be
