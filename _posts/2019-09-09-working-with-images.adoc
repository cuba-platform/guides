...
:page-icone: https://www.cuba-platform.com/guides/images/working-with-images/guide_icone.svg
:page-root: ../../../
:project_id: cuba-petclinic-working-with-images
:page-url-first-image: images/working-with-images/login-screen.png
:java_version: 8
:cuba_version: 7.0
...
++++
<a href="images/working-with-images/adjustments-cuba-petclinic-overview.gif"><img src="images/working-with-images/login-screen.png"/></a>
++++
