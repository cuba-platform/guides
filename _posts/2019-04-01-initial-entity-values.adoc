...
For the petclinic example, the use case as described above is to generate a `visitNumber` directly before the visit entity is stored. The `VisitNumberGenerator` bean acts
...
TIP: complete summary with mentioning pre-persist examples
