...
image::/images/creating-business-logic-in-cuba/using_client_beans_1.png[class diagramm using client tier beans]
...
image::/images/creating-business-logic-in-cuba/using_services_1.png[class diagramm using services]
