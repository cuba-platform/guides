...
In a CUBA application, just like any other Java application, it is possible and recommended to write tests, that exercise parts of the target application.
