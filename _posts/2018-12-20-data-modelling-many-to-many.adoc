...
The many-to-many association implies that multiple records of one table are related to multiple records of another table. The joining table will store primary keys of both related entities. Optionally, this table may contain additional columns.
