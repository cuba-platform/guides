...
The first message is received via the `MessageBundle` Interface. `MessageBundle` is a new shorthand mechanism introduced in CUBA 7.0, that fetches a particular message from the message pack of the calling Java class.
