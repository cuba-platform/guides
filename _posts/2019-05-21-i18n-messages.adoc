...
CUBA deals with translations as it is common for other Java based applications. Messages or different languages / locales are stores next to the source-code within the same package in `.properties` files.
