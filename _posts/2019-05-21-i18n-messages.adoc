...
In the Petclinic example, the translations for the entity attributes have been created by creating the `messages_de.properties` files in the project.


[TIP]
====
CUBA Studio offers a Resouce Bundle view for every package. It allows to see an overview over the the translations for the selected package.
