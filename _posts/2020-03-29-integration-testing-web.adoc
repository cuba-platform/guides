...
public class OwnerBrowseTest {
    ...
    @BeforeEach
    public void setUp() {
        ownerFactory = environment.getContainer().getEntityFactory(Owner.class, TestEntityState.NEW);

        mockDataService();

        data = new PetclinicData(ownerFactory);
...
=== Create Disease Warning Mailing Test
