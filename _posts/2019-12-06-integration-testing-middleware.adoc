...
On the one hand it makes the test data setup easier, as there are already some data to rely upon.
...
On the other hand, relying on test data that is defined outside the test case also comes with a maintenance cost.
