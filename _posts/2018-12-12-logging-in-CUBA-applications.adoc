...
* https://doc.cuba-platform.com/manual-{cuba-version}/logging_setup_tomcat.html(Docs: Setup Logging for local development)
* https://doc.cuba-platform.com/manual-{cuba-version}/log_dir.html(Docs: Log directory of CUBA application)
* https://doc.cuba-platform.com/manual-{cuba-version}/build.gradle_buildWar.html(Docs: Build WAR with logging configuration)