...
Click the Login button in side menu to proceed to login screen and enter the system as administrator.
...
Restart the app and try to open Vets screen using the following link:
...
In this section, we'll demonstrate how to implement login using a modal dialog. Later we will place social buttons on this dialog.
...
This approach is called "OAuth Web Flow" and we will use it to integrate social
