...
:page-icone: https://www.cuba-platform.com/guides/images/initial-entity-values/guide_icone.svg
:page-root: ../../../
:project_id: cuba-petclinic-initial-entity-values
:page-url-first-image: images/initial-entity-values/login-screen.png
:java_version: 8
:cuba_version: 7.0
...
++++
<a href="images/initial-entity-values/adjustments-cuba-petclinic-overview.gif"><img src="images/initial-entity-values/login-screen.png"/></a>
++++
...
With CUBA 7 the `ScreenBuilders` UI-API was introduced. It allows programmatic creation and screen opening via a Builder pattern, which exposes various options for further configuration.
...
image::initial-entity-values/regular-checkup-1-select-pet.png[Step 1: Pet selection, link="/guides/images/initial-entity-values/regular-checkup-1-select-pet.png"]

image::initial-entity-values/regular-checkup-2-prefilled-visit.png[Step 2: Prefilled visit screen, link="/guides/images/initial-entity-values/regular-checkup-2-prefilled-visit.png"]
