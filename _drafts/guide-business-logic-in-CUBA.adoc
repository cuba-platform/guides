...
Assuming the discount calculation should be executed when a user clicks a button on the Owners's browser screen, the most straightforward way to accomplish this is to put the calculation logic right in the associated controller class.
